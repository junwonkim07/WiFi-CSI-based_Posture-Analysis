...
### Pipeline
1. Collect CSI amplitude and phase data  
2. Preprocess signals  
3. Extract motion-related features  
4. Apply deep learning models (CNN / RNN)  
5. Output 2D or 3D skeleton with 17 keypoints  
